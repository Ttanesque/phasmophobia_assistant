...
// ghost description
  ...
  "banshee.evidences": "Ghost orb | Fingerprints | Dots",
  // demon
  "demon.description1":
  ...
  "demon.evidences": "Freezing Temperatures | Ghost Writing | Fingerprint",
  // jin
  "jinn.description1":
  ...
  "jinn.evidences": "EMF Level 5 | Freezing temperature | Fingerprint",
  // mare
  "mare.description1":
  ...
  "mare.evidences": "Spirit box | Ghost writing | ghost orb",
  // oni
  "oni.description1":
  ...
  "oni.evidences": "EMF Level 5 | Freezing temperature | Dots Projector",
  // phantom
  ...
  "phantom.evidences": "Spirit Box  | Fingerprint | Dots projector",
  // poltergeist
  ...
  "poltergeist.evidences": "Ghost Writing | Fingerprints | Spirit Box",
  // revenant
  ...
  "revenant.evidences": "Freezing temperature | Ghost Writing | Ghost orb",
  // shade
  "shade.description1":
  ...
  "shade.evidences": "EMF Level 5 | Freezing temperature | Ghost Writing",
  // spirit
  "spirit.description1":
  ...
  "spirit.evidences": "EMF Level 5 | Spirit Box | Ghost writing",
  // wraith
  "wraith.description1":
  ...
  "wraith.evidences": "EMF Level 5 | Spirit Box | Dots",
  // yurei
  "yurei.description1":
  ...
  "yurei.evidences": "Freezing Temperatures | Ghost Orb | Dots Projector",
  // Yokai
  "yokai.strength":
      "Talking near a Yokai will anger it and increase its chance of attacking.",
  "yokai.weakness": "When hunting, a Yokai can only hear voices close to it.",
  // Hantu
  // Goryo
  // Myling
// objective / item
...
// evidences
  ...
  "emf.level.5.ghosts": "Jinn | Shade | Oni | Wraith | Spirit | Goryo | Myling",
  // fingerprints
  ...
  "fingerprints.ghosts":
      "Phantom | Banshee | Jinn | Demon | Poltergeist | Hantu | Goryo | Myling",
  // freezing temp
  ...
  "freezing.temperatures.ghosts":
      "Jin | Revenant | Shade | Oni | Demon | Yurei | Hantu",
  // ghost orb
  ...
  "ghost.orbs.ghosts": "Banshee | Revenant | Mare | Yurei | Yokai | Hantu",
  // ghost writing
  ...
  "ghost.writing.ghosts":
      "Revenant | Shade | Mare | Demon | Poltergeist | Spirit | Myling",
  // spirit box
  ...
  "spirit.box.ghosts": "Phantom | Wraith | Mare | Poltergeist | Spirit | Yokai",
